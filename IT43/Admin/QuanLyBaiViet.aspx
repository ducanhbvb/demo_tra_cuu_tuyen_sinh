...
<asp:Content ContentPlaceHolderID="HeadContent" runat="server">
    <%-- span.form-check-input fix is in Content/Admin.css --%>
</asp:Content>
...
<div class="page-header mb-4">
    <div>
        <h4 class="page-header-title">
            <i class="bi bi-file-earmark-text" style="color: var(--accent);"></i> Quản lý Bài viết
        </h4>
        <div class="page-header-sub">
            Dashboard / <strong>Bài viết</strong> — Quản lý tin tức và bài viết
        </div>
    </div>
    <button type="button" class="btn btn-primary" data-clear-modal="true" data-bs-toggle="modal" data-bs-target="#modalBaiViet">
...
<div class="admin-filter-bar mb-4">
    <asp:DropDownList ID="ddlTruong" runat="server" data-filter-truong="true" CssClass="form-select" style="max-width:220px;">
                ...
                <asp:TemplateField HeaderText="">
                    <ItemTemplate>
                        ...
                        <asp:LinkButton runat="server" CommandName="XoaBV"
                            ...
                            OnClientClick="return confirm('CẢNH BÁO: Đây là thao tác XÓA VĨNH VIỄN bài viết này. Nội dung và ảnh liên quan có thể bị xóa khỏi hệ thống. Bạn đã chắc chắn muốn tiếp tục?')" title="Xóa vĩnh viễn bài viết">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        <label class="form-label">Người đăng / chữ ký</label>
                        <asp:TextBox ID="txtTenNguoiDang" runat="server" CssClass="form-control"
                            placeholder="Để trống để dùng mặc định theo quyền tài khoản" MaxLength="150" />
                        <div class="form-text">Ví dụ: Admin, Moderator, Ban Biên tập, Nguyễn Văn A...</div>
                    </div>
                    <div class="col-md-6">
            ...
            <div class="modal-body">
                ...
                <div class="admin-article-preview-content">
                    <div class="d-flex gap-3 text-muted small mb-3">
                        ...
                        <span><i class="bi bi-person me-1"></i><span id="pvPostAuthor"></span></span>
	...
	<asp:Content ContentPlaceHolderID="ScriptContent" runat="server">
	    ...
	    <script>
	        ...
	        function resetModalBaiViet() {
	            ...
	            ['<%= txtTieuDe.ClientID %>', '<%= txtSlug.ClientID %>', '<%= txtTheLoai.ClientID %>',
	             '<%= txtTenNguoiDang.ClientID %>'].forEach(function(id) {
	                var el = document.getElementById(id);
	                if (el) el.value = '';
	            });
	            var ddl = document.getElementById('<%= ddlMTruong.ClientID %>');
	           ...
	           document.addEventListener('DOMContentLoaded', function() {
	               ...
	               AdminValidator.init('form', {
	                   ...
	                   '<%= txtTenNguoiDang.ClientID %>': [
	                       AdminValidator.rules.maxLen(150, 'Người đăng / chữ ký tối đa 150 ký tự.')
	                   ]
	               }, { triggerButtonId: '<%= btnLuuBV.ClientID %>' });
	           });
	    </script>
	</asp:Content>
